AncientOS 3.9 | Primeval | Koshiki | August 17, 2020
...
* HOTFIX UPDATE.
* Fixed Apps & Notification settings force close.
* Removed Battery info.
* Added New Realme FOD Animations.
* Latest Ancient source upstream.
* Updated blobs from C06 Firmware.
* Added Moto Dolby.
* Updated Coral August fp.
* Kernel compiled with Latest Proton Clang 12.0.0
* Many Improvements.
